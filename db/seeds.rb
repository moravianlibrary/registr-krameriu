...
Library.create(name: 'Severočeská vědecká knihovna v Ústí nad Labem', code: 'svkul', url: 'https://kramerius.svkul.cz/')
...
Library.create(name: 'Moravskoslezská vědecká knihovna v Ostravě', code: 'svkos', url: 'https://camea2.svkos.cz/')
...
Library.create(name: 'Národní muzeum - Zvuk', code: 'nmzv', url: 'http://zvuk.nm.cz/')
