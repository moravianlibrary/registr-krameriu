...
class LibrariesControllerTest < ActionController::TestCase
  ...
  test "should create library" do
    assert_difference('Library.count') do
      post :create, library: { code: @library.code, name: @library.name, url: @library.url, version: @library.version }
    end
  ...
  test "should update library" do
    patch :update, id: @library, library: { code: @library.code, name: @library.name, url: @library.url, version: @library.version }
    assert_redirected_to library_path(assigns(:library))
  end
